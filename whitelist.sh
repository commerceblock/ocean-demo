...
e-cli readwhitelist keys.main $kycPubKey
e-cli readwhitelist keys.client $kycPubKey2
e1-cli readwhitelist keys.main $kycPubKey
e1-cli readwhitelist keys.client $kycPubKey2
...
printf "\n"
e-cli addtowhitelist $clientAddress1 $clientPubKey1 $kycPubKey2
e-cli addtowhitelist $clientAddress2 $clientPubKey2 $kycPubKey2
e-cli addtowhitelist $clientAddress3 $clientPubKey3 $kycPubKey2
e1-cli addtowhitelist $clientAddress1 $clientPubKey1 $kycPubKey2
e1-cli addtowhitelist $clientAddress2 $clientPubKey2 $kycPubKey2
e1-cli addtowhitelist $clientAddress3 $clientPubKey3 $kycPubKey2
